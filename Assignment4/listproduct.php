...
<div id="wrapper"> 
 ...
 <!--header-starts-->
  ...
  <div class="container">
 	...
 	<br>
 	<button style="float: right;" class="btn-success btn "> <a href="cproduct.php" class="text-white"> Create Product </a>  </button> 
 	<br><br>
 	...
 	<td> <img src=" <?php echo $res['pupload'];  ?> "></td>
  	<td> <?php echo $res['pcategory'];  ?> </td>
 	<td> <button style="margin: 5px" class="btn-danger btn"> <a href="deleteproduct.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button>
	<button style="margin: 5px" class="btn-primary btn"> <a href="editproduct.php?id=<?php echo $res['id']; ?>" class="text-white"> Update </a> </button> </td>
