...
if(isset($_POST['submit'])){
  ...
  $pname = $_POST['pname'];
  $pprice = $_POST['pprice'];
  $pupload = $_FILES['pupload'];
  $filename=$pupload['name'];
  $fileerror=$pupload['error'];
  $filetmp=$pupload['tmp_name'];
  $pcategory = $_POST['selectcat'];
  $filexp=explode('.',$filename);
  $filecheck=strtolower(end($filexp));
 ...
 $q = "INSERT INTO `product`(pname, pprice, pupload, pcategory) VALUES ('$pname', '$pprice', '$destination', '$pcategory')";
		...
		<div class="filable_form_container">
			...
			<div class="form_container_block">
				<ul>
					...
					<li class="fileds">
						<div class="age_fileds">
							...
							<br>
							<input name="pupload" type="file" id="pupload" > 
						</div>
					</li>
					<li class="fileds">
						<div class="age_fileds">
							<label for="selectcat">Select Category</label>
 							 <select class="text-dark" name="selectcat" id="selectcat">
 							 <?php
 							 include 'connect.php';
				...
				<div class="next_btn_block">
					<div class="next_btn">
						<input type="submit"  name="submit" class="btn btn-success btn1" value="submit">
						<!--<a id="id" onclick="return Valid()">Proceed to Step 2 <span><img src="images/small_triangle.png" alt="small_triangle"> </span></a>-->
					</div>
				</div>
			</div>
		</div>
...
function validation() {
	...
	var lname=document.getElementById('pprice').value;
	var uname=document.getElementById('pimage').value;
	var iname=document.getElementById('pcategory').value;
	if (fname == ""){
