 ...
 <!--header-starts-->
  ...
  <!-- Content Section Start-->
   <div class="container">
 	<div class="col-lg-12">
 	<br><br>
 	<h1 class="text-secondary text-center" > Display Table Data </h1>
 	<button style="float: right;" class="btn-success btn "> <a href="ccategory.php" class="text-white"> Create Category </a>  </button> 
 	<br><br>
 	...
 	<td> <button  style="margin: 5px" class="btn-danger btn"> <a href="deletecategory.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button> 
 	 <button style="margin: 5px" class="btn-primary btn"> <a href="ecategory.php?id=<?php echo $res['id']; ?>" class="text-white"> Update </a> </button> </td>
...
<script type="text/javascript">
function validation() {
	var fname=document.getElementById('ccategory').value;
	if (fname == ""){
